...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FEATURES] = LAYOUT(
        ...
        _______, TOGGLE_AUTOCORRECT,_______,_______,_______, _______, _______, _______,_______,_______,_______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, TOGGLE_JIGGLER,_______, _______, _______, _______,          _______,          _______,
    ...
    [_MOUSE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_MS_U, MS_BTN2,
        _______, _______, _______,                            _______,                            _______, _______, MS_BTN1, KC_MS_L, KC_MS_D, KC_MS_R
    ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FEATURES] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
...
// ============================================================================
// GMMK Pro Specific: Default to Windows Mode
// ============================================================================

void keyboard_post_init_user(void) {
    // Call userspace init first
    keyboard_post_init_user_rgb();

    // GMMK Pro doesn't have a physical OS switch, so default to Windows mode
    // This sets layer 2 (_WIN_BASE) as the default layer
